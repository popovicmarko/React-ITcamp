  ...
  return (
    <div className='cardContainer' id='card'>
      ...
      <div className='container'>
        ...
        <PersonCard img='https://avatars.githubusercontent.com/u/89378479?v=4' name='Dzenan Kosuta' location='Novi Pazar, Serbia' about='I am a student of the State University of Novi Pazar in Novi Pazar, front-end devloper and a passionate learner.' />
      </div>
    </div>
  );
}